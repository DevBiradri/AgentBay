            ...
            <div className="relative py-12 bg-gray-900 sm:py-16 lg:py-20 xl:pt-32 xl:pb-44">
                ...
                <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="max-w-xl mx-auto text-center lg:max-w-md xl:max-w-lg lg:text-left lg:mx-0">
                        <h1 className="text-3xl font-bold text-white sm:text-4xl xl:text-5xl xl:leading-tight">Where AI Meets Commerce</h1>
                        <p className="mt-8 text-base font-normal leading-7 text-gray-400 lg:max-w-md xl:pr-0 lg:pr-16">The world's first AI-powered marketplace that thinks, learns, and sells for you. Experience the future of online commerce today.</p>
